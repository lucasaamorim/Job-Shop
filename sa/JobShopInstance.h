...
struct Operation {
  ...
  Operation(int job_id, int machine_id, int operation_id, int position_in_job, int duration) : 
    job_id(job_id), machine_id(machine_id), operation_id(operation_id), position_in_job(position_in_job), duration(duration) {}
